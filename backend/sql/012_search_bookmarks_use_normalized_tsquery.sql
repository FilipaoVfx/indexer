-- Minimal fix: wrap raw_query in split_camelcase_for_tsquery() for the tsquery builder.
-- This is identical to 004_search_bookmarks_scalable.sql except for ONE line:
-- websearch_to_tsquery('simple', i.raw_query)
-- becomes:
-- websearch_to_tsquery('simple', public.split_camelcase_for_tsquery(i.raw_query))
  ...
  prepared AS (
    SELECT
      ...
      CASE
        ...
        ELSE websearch_to_tsquery('simple', public.split_camelcase_for_tsquery(i.raw_query))
      END AS query_ts,
